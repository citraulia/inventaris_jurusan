...
CREATE TABLE `kumpulan_barang_dipinjam` (
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `status_barang` TINYINT DEFAULT 2
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `kumpulan_barang_dipinjam` (`kumpulan_id`, `barang_dipinjam_fk`, `transaksi_fk`, `created_at`, `updated_at`, `status_barang`) VALUES
(1, 'kom404cp4', 1, '2022-03-02 01:00:49', '2022-03-02 01:00:49', 1),
(2, 'kom404mo5', 1, '2022-03-02 01:00:49', '2022-03-02 01:00:49', 1),
(3, 'kom404mp6', 1, '2022-03-02 01:00:49', '2022-03-02 01:00:49', 1);
