    ...
    <div class="container-fluid">
        ...
        <div class="card border-dark mb-3">
            ...
            <div class="card-body text-dark">
                <form action="<?= base_url('Jurusan/MyProfile/update/' . $userJurusan['user_id']); ?>" method="POST">
                    <?= csrf_field(); ?>
                    ...
                    <button type="submit" class="btn btn-success mt-lg-3"><i class="fas fa-check mr-3"></i>Simpan Perubahan Data</button>
                    <a href="<?= base_url('jurusan/myprofile/' . $userJurusan['user_slug']); ?>" class="btn btn-danger mt-lg-3"><i class="fas fa-times mr-3"></i>Batal</a>
                </form>
            </div>
        </div>
    </div>
