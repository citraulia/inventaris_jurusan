...
<main>
    <div class="container-fluid">
        <h1 class="mt-4">Detail Pengajuan Penghapusan Barang</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="<?= base_url('jurusan/pengelolaan'); ?>">Riwayat Pengelolaan Barang</a></li>
            <li class="breadcrumb-item active">Detail Pengajuan Penghapusan Barang</li>
        </ol>
        ...
        <div class="card border-dark mb-3">
            ...
            <?php if ($pengelolaanBarang['pengelolaan_status'] != 0) : ?>
                <div class="card-header">Alasan Penghapusan Barang</div>
            <?php endif; ?>
        ...
        <div class="card border-dark mb-3">
            <div class="card-header">Penghapusan <?= $barangPending['pending_nama']; ?></div>
            <div class="card-body text-dark">
                <form>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control bg-warning" id="status" name="status" style="font-weight: bold;" value="<?= $status; ?>" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="dipinjamkan">Apakah Barang Boleh Dipinjamkan?</label>
                            <input type="text" class="form-control bg-warning" id="dipinjamkan" name="dipinjamkan" style="font-weight: bold;" value="<?= ($barangPending['pending_dipinjamkan']) ? 'BOLEH DIPINJAMKAN' : 'TIDAK DIPINJAMKAN'; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
