            ...
            <div class="card-body text-dark">
                <form action="<?= base_url('Peminjam/MyProfile/update/' . $userPeminjam['peminjam_id']); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control py-4 <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" id="inputEmail" name="email" value="<?= (old('email')) ? old('email') : $userPeminjam['peminjam_email']; ?>">
                    ...
                    <a href="<?= base_url('peminjam/myprofile/' . session('slug')); ?>" class="btn btn-danger mt-lg-2"><i class="fas fa-times mr-3"></i>Batal</a>
                </form>
